...
# =========================
# Training config (COOPERATIVE MARL — v2)
# =========================
SEED = 42
MAX_EPISODES = 500          # v2: increased from 200
MAX_STEPS = 3600
...
EPSILON_START = 1.0
EPSILON_END = 0.05
EPSILON_DECAY = 0.990       # v2: changed from 0.995 — hits floor at ~ep 300

DECISION_INTERVAL = 5
MIN_GREEN = 8
YELLOW_TIME = 3

MODEL_DIR = "checkpoints_coop_marl_v2"   # v2: separate folder, never overwrites v1
...
def main():
    ...
    for episode in range(1, MAX_EPISODES + 1):
        ...
        wait_history.append(metrics["avg_wait_per_step"])
    ...
    print(f"\n✅ Cooperative v2 training complete. Models and plots saved to '{MODEL_DIR}'.")
