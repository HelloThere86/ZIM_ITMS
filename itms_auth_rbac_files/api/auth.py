...
Roles:
  ...
  supervisor  - review/approve violations, audit log, read access
  officer     - view/log violations, send SMS, view results/fines
...
def require_permission(permission: str):
    ...
    Usage:
      ...
      def audit(_: UserOut = Depends(require_permission("audit:read"))):
          ...
    """
